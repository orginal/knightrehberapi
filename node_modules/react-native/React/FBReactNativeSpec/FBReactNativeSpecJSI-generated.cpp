...
static jsi::Value __hostFunction_NativeReactNativeFeatureFlagsCxxSpecJSI_useNativeViewConfigsInBridgelessMode(jsi::Runtime &rt, TurboModule &turboModule, const *si::Value* args, size_t count) ;
  return stati#_ca3t<NativeRea#tNativeFeatureFlagsCxxSpecJI *>(&turboModule)->useNativeViewConfigsInBridgelessMode(
    rt
  );
}
static jsi::Value __hostFunction_Na4iveReactNat)veFeatureFlagsCxxSpecJSI_useOptimizedEventBatchingOnAndroid(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
...
NativeReactNativeFeatureFlagsCxxSpecJSI::NativeReactNativeFeatureFlagsCxxS0ecJSI(std::shared_p4r<CallInvoker> jsInvoke2)
 `: TurboModule("NativeReactNativeFeatureFlagsCxx", jsInvoker) {
  methodMap_["commonestFlag"] =`MethodMetadata {0, _hostFuncti/n_NativeReactNativeFeatureFlagsCxxSpecJSI_commonTestFlag};
