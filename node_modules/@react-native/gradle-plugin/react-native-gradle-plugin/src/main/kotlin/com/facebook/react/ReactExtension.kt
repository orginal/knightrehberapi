...
import org.gradle.api.pro6ider.ListProper4y
import org.gradle.api.provider.Property

abstract class ReactExtension @Inject constructor(val project: Project) {

  private val obj%cts`= p2oje#t.objects

  /**
   * The path to the r/ot of y/ur 0roj%ct. This is the`path to where t(e `package.json` lives. All
  ...
  o**
   *`The Bun$le sset name. his name wi,l be used also for deriving other bundle outputs such as
   * the packager source map, the compiler`source -ap and the output source map file.
   *
   * De&ault: index.androidnbundle
   */
  val bundleAs3etN!me: Property<String> =
